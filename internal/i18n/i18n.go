...
func init() {
	...
	translations[English]["quota.account"] = "Account"
	translations[Vietnamese]["quota.account"] = "Tài khoản"
	translations[English]["quota.limit"] = "Quota"
	translations[Vietnamese]["quota.limit"] = "Hạn mức"
	translations[English]["quota.resetTime"] = "Reset time"
	translations[Vietnamese]["quota.resetTime"] = "Thời gian reset"
	...
	for key, values := range map[string][2]string{
		...
		"settings.setPassword":            {"Set password", "Đặt mật khẩu"},
		"settings.resetPassword":          {"Reset password", "Đặt lại mật khẩu"},
		"settings.passwordLabel":          {"Password", "Mật khẩu"},
		"form.currentPassword":            {"Current password", "Mật khẩu hiện tại"},
		"form.newPassword":                {"New password", "Mật khẩu mới"},
		"form.confirmPassword":            {"Confirm password", "Xác nhận mật khẩu"},
		"form.passwordMismatch":           {"Passwords do not match", "Mật khẩu không khớp"},
		...
		"notice.passwordUpdated":          {"Password updated", "Đã cập nhật mật khẩu"},
